...
namespace ProjectWaterfallUnitTests
{
    ...
    public class AutoWorkshiftTests
    {
        ...
        public void PopulatemySchedule()
        {
            ...
            ToAdd = new WorkshiftData("John4", myDate, 1, "Thursday", "dep2");
            mySchedule.Add(ToAdd);
            ...
            ToAdd = new WorkshiftData("John5", myDate, 1, "Tuesday", "dep2");
            mySchedule.Add(ToAdd);
            ...
            myDate = DateTime.Parse("6/16/2020");
            ToAdd = new WorkshiftData("John6", myDate, 1, "Tuesday", "dep2");
            mySchedule.Add(ToAdd);
            ...
            myDate = DateTime.Parse("6/15/2020");
            ToAdd = new WorkshiftData("John4", myDate, 1, "Monday", "dep2");
            mySchedule.Add(ToAdd);

            myDate = DateTime.Parse("6/15/2020");
            ToAdd = new WorkshiftData("John4", myDate, 2, "Monday", "dep2");
            mySchedule.Add(ToAdd);
            ...
            myDate = DateTime.Parse("6/16/2020");
            ToAdd = new WorkshiftData("John4", myDate, 2, "Tuesday", "dep2");
            mySchedule.Add(ToAdd);
        ...
        public void TestAlgorithm()
        {
            ...
            PopulatemySchedule();
           List<WorkshiftData>GeneratedDatas= autoWorkshift.GenerateWorkshiftSchedule();
